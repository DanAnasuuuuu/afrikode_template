...
if($_SERVER['REQUEST_METHOD'] == 'POST')
   ...
   ?>
              <form action="" method="post" enctype="multipart/form-data">
                                              ...
                                              <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label"> Team's Name</label>
                                                            <input type="text" class="form-control"  name="name" placeholder="Enter Team's Name">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label">Position</label>
                                                            <input type="text" class="form-control"  name="position" placeholder="Enter Team's Position">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label">About</label>
